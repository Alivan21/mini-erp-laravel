<x-app-layout>
  <x-slot name="header">
    <div class="flex justify-between items-center">
      ...
      <a href="{{ route('inventory.material.print_pdf') }}" class="no-underline">
        <button type="button"
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
          ...
          <nav class="flex items-center justify-between p-4 border-t" aria-label="Table navigation">
            <span class="text-sm font-normal text-gray-500">
              Showing <span class="font-semibold text-gray-900">{{ $materials->firstItem() }}</span>
              - <span class="font-semibold text-gray-900">{{ $materials->lastItem() }}</span>
              of <span class="font-semibold text-gray-900">{{ $materials->total() }}</span>
            </span>
            {{ $materials->links() }}
          </nav>
        </div>
