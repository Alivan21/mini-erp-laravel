      ...
      <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
        ...
        >
          ...
          <div class="flex items-center">
            <a
              href="{{ route("inventory.stock.create") }}"
              class="no-underline"
            >
              <button
                type="button"
        ...
        <form action="{{ route("inventory.stock.index") }}" method="GET">
          <div
            class="flex items-center gap-5 border-b border-gray-200 bg-white px-4 py-3 sm:px-6"
          >
            <select
              name="month"
            ...
            <button
              type="button"
              onclick="window.location.href='{{ route("inventory.stock.index") }}'"
          ...
          <table class="w-full text-left text-sm text-gray-500 rtl:text-right">
            <thead class="bg-gray-50 text-xs uppercase text-gray-700">
              <tr>
                ...
                <th scope="col" class="px-6 py-3">Stok Masuk</th>
                <th scope="col" class="px-6 py-3">Stok Keluar</th>
            ...
            <tbody>
              @foreach ($stocks as $stock)
                <tr class="border-b bg-white hover:bg-gray-50">
                  ...
                  <td class="px-6 py-4">
                    <a
                      href="{{ route("inventory.stock.edit", $stock->id) }}"
                      class="no-underline"
                    >
                      <button
                        type="button"
