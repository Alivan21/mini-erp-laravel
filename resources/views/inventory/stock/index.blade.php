        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
          ...
          <nav class="flex items-center justify-between p-4 border-t" aria-label="Table navigation">
            <span class="text-sm font-normal text-gray-500">
              Showing <span class="font-semibold text-gray-900">{{ $stocks->firstItem() }}</span>
              - <span class="font-semibold text-gray-900">{{ $stocks->lastItem() }}</span>
              of <span class="font-semibold text-gray-900">{{ $stocks->total() }}</span>
            </span>
            {{ $stocks->links() }}
          </nav>
        </div>
