  ...
  <div class="py-12">
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
        ...
        <form method="POST" action="{{ route('inventory.stock.update', $stock->id) }}"
          ...
          <div class="mb-5">
            ...
            <select id="material" name="material_id" required
              ...
              <option value="{{ $stock->material->id }}" selected>{{ $stock->material->name }}</option>
            </select>
          </div>
          <div class="mb-5">
            ...
            <input type="number" id="quantity" name="quantity_in" value="{{ $stock->quantity_in }}"
              min="1" required
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 placeholder-gray-500">
          </div>
          <div class="flex">
