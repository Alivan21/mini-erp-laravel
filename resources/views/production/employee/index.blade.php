        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <tbody>
              @foreach ($employees as $employee)
                <tr class="border-b bg-white hover:bg-gray-50">
                  ...
                  <td class="whitespace-nowrap px-6 py-4 font-medium uppercase text-gray-900">
                    {{ $employee->role }}
                  </td>
                  <td class="px-6 py-4">
          ...
          <nav class="flex items-center justify-between p-4 border-t" aria-label="Table navigation">
            <span class="text-sm font-normal text-gray-500">
              Showing <span class="font-semibold text-gray-900">{{ $employees->firstItem() }}</span>
              - <span class="font-semibold text-gray-900">{{ $employees->lastItem() }}</span>
              of <span class="font-semibold text-gray-900">{{ $employees->total() }}</span>
            </span>
            {{ $employees->links() }}
          </nav>
        </div>
