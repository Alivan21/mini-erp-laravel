      ...
      <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
        <div
          ...
          <div class="flex items-center">
            <a href="{{ route('sales.customer.create') }}" class="no-underline">
              <button type="button"
            ...
            <tbody>
              @foreach ($customers as $customer)
                <tr class="border-b bg-white hover:bg-gray-50">
                  ...
                  <td class="px-6 py-4">
                    <a href="{{ route('sales.customer.edit', $customer->id) }}" class="no-underline">
                      <button type="button"
                    ...
                    <form action="{{ route('sales.customer.destroy', $customer->id) }}" method="POST"
                      class="inline-block">
                      @csrf
                      @method('DELETE')
