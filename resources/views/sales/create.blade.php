        ...
        <div
          ...
          <div class="flex flex-col">
            ...
            <p class="mt-1 max-w-2xl text-sm leading-5 text-gray-500">
              Silahkan lengkapi form berikut untuk menambah data penjualan baru.
            </p>
          </div>
        </div>
        <form method="POST" action="{{ route('sales.store') }}" class="mx-auto p-4 sm:px-6">
          @csrf
          <div class="mb-5">
